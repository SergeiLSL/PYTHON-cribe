...
https://pythonworld.ru/moduli/modul-math.html  на русском
https://docs.python.org/3/library/math.html  библиотека
"""
"""
...
Эквивалент встроенной функции sum(), но math.fsum() более точна 
...
math.modf(X) - возвращает дробную и целую часть числа X. 
Оба числа имеют тот же знак, что и X.
...
math.hypot(X, Y) - вычисляет гипотенузу треугольника 
